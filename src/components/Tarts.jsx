...
export default function Trats() {
  return (
    <div className="p-20 md:p-16 lg:p-25 bg-white">
      {/* Heading */}
      <div className="flex  gap-2 bg-[#E7D8C7] border-[#E7D8C7] p-3 w-fit font-bold text-xl ">
        <GiPieSlice className="text-[#BE996C] text-2xl" />
        <span className="text-[#010101]">Pies, Crisps, & Tarts</span>
      </div>
      ...
      <div className="bg-[#FFFFFF] border border-[#E7D8C7]  md:justify-center sm:justify-center p-6">
        ...
        >
          ...
          {
            img: "https://sallysbakingaddiction.com/wp-content/uploads/2015/07/perfect-pie-crust-3-600x900.jpg",
            
            title: "Homemade Buttery Flaky Pie Crust",
            comments: "45 Comment",
          },
          ].map((card, index) => (
            <div
