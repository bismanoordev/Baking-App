...
export default function DropCookies() {
  return (
    <div className="p-20 md:p-16 lg:p-25 bg-white">
      ...
      <div className="flex  gap-3 bg-[#F0D9D6] border-[#F0D9D6] p-3 w-fit font-bold text-xl ">
        ...
        <span className="text-[#010101]">Drop Cookies</span>
      </div>
      ...
      <div className="bg-[#FFFFFF] border border-[#F0D9D6]  md:justify-center sm:justify-center p-6">
        ...
        >
          ...
          {[
            {
              img: "https://sallysbakingaddiction.com/wp-content/uploads/2019/08/maple-brown-sugar-cookies-600x900.jpg",
              title: "Maple Brown Sugar Cookies",
              comment: "Comment",
            },
            {
              img: "https://sallysbakingaddiction.com/wp-content/uploads/2013/05/snickerdoodles-600x900.jpg",
              title: "Soft & Thick Snickerdoodles",
              comment: "19 Comment",
            },
            {
              img: "https://sallysbakingaddiction.com/wp-content/uploads/2017/12/molasses-cookies-recipe-600x900.jpg",
              title: "Seriously Soft Molasses Cookies",
              comment: "5 Comment",
            },
            {
              img: "https://sallysbakingaddiction.com/wp-content/uploads/2013/09/best-pumpkin-chocolate-chip-cookies-600x900.jpg",
              title: "Pumpkin Chocolate Chip Cookies",
              comment: "450 Comment",
            },
            {
              img: "https://sallysbakingaddiction.com/wp-content/uploads/2015/11/christmas-chocolate-crinkle-cookies-600x900.jpg",
              title: "Double Chocolate Crinkle Cookies",
              comment: "22 Comment",
            },
            {
              img: "https://sallysbakingaddiction.com/wp-content/uploads/2012/09/white-chocolate-macadamia-nut-cookies-1-600x900.jpg",
              title:
