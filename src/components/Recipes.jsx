...
export default function Recipes() {
  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] p-10 bg-white">
      <a
        href="#"
        className="flex flex-col items-center bg-[#F8F0EC] 
      ...
      >
        ...
        <img
          ...
          src="https://embed.filekitcdn.com/e/gjcUYKpfz85DEqCXjh6qUd/7QmazKJkGFcMWDWQXp2Sf1"
          alt="Baking recipes"
        />
      </a>
    </div>
