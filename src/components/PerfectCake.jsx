...
export default function PerfectCake() {
  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] p-10 pt-20 bg-white">
      <a
        href="#"
        className="flex flex-col items-center bg-[#E2ECF2] 
      ...
      >
        ...
        <div className="flex flex-col justify-between w-full md:w-1/2 p-10 leading-relaxed">
          ...
          In this free email series, I walk you through my best cake baking success tips, popular cake recipes, easy decorating techniques, and in-depth tutorials. Sign up below and I’ll send it right away!
          </p>
        ...
        <img
          ...
          src="https://embed.filekitcdn.com/e/gjcUYKpfz85DEqCXjh6qUd/bnPdzVVpowsz7Z1ykMjp15"
          alt="Baking recipes"
        />
      </a>
    </div>
