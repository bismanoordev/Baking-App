...
export default function Popularsweet() {
  return (
    <div className="p-20 md:p-16 lg:p-25 bg-white">
      ...
      <div className="flex  gap-2 bg-[#F4DDC1] border-[#F4DDC1] p-3 w-fit font-bold text-xl ">
        ...
        <span className="text-[#010101]">Popular Sweet Rolls</span>
      </div>
      ...
      <div className="bg-[#FFFFFF] border border-[#F4DDC1]  md:justify-center sm:justify-center p-6">
        ...
        >
          ...
          {[
            {
              img: "https://sallysbakingaddiction.com/wp-content/uploads/2013/12/giant-cinnamon-roll-cake-4-600x900.jpg",
              title: "Giant Cinnamon Roll Cake",
              comment: "Comment",
            },
            {
