...
export default function Pieweek() {
  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] p-10 pt-20 bg-white">
      <a
        href="#"
        className="flex flex-col items-center bg-[#E7D8C7] 
      ...
      >
        ...
        <img
          ...
          src="https://embed.filekitcdn.com/e/gjcUYKpfz85DEqCXjh6qUd/cx7y6DS9FdUKHk84ZJsX66"
          alt="Baking recipes"
        />
      </a>
    </div>
