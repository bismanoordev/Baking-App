...
export default function Palooza() {
  ...
  return (
    <div className="flex items-center justify-center min-h-[80vh] p-10 pt-20 bg-white">
      <a
        href="#"
        className="flex flex-col items-center bg-[#F9F1F0] 
      ...
      >
        ...
        <div className="flex flex-col justify-between w-full md:w-1/2 p-10 leading-relaxed">
          ...
          Every year in December, I publish 10 new cookie recipes in a row and I call it Sally's Cookie Palooza! Sign up below to join. We’ll send you 20 of my most popular cookie recipes, plus all of this year's new Palooza recipes as they're published.
        ...
        <img
          ...
          src="https://embed.filekitcdn.com/e/gjcUYKpfz85DEqCXjh6qUd/fr1PSETDVHobbd7SfkzrEY"
          alt="Baking recipes"
        />
      </a>
    </div>
