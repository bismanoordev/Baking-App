  ...
  return (
    <div className="p-20 md:p-16 lg:p-25 bg-white">
        <div className="flex items-center justify-center gap-3 bg-[#EDD6CC] border-[#F2D6D0] p-3 w-fit font-bold text-xl">
          ...
          <span className="text-[#010101] text-xl">Fall Baking Season</span>
        </div>

       <div className="bg-[#FFFFFF] border border-[#EDD6CC] md:justify-center sm:justify-center">
        <p className="text-xl px-7 pt-2">Fall baking is here! This beloved baking season is full of the flavors of pumpkin, apple, cinnamon, maple, and comforting warm spices.</p>
       <div
    ...
    >
      <div className="group flex flex-col bg-[#F5F3F2] cursor-pointer lg:h-[73vh]  md:h-[73vh]
        ...
        <img
          src="https://sallysbakingaddiction.com/wp-content/uploads/2019/07/apple-cinnamon-baked-oatmeal-cups-4-600x900.jpg"
          alt=""
    ...
    >
      <div className="group flex flex-col bg-[#F5F3F2] cursor-pointer lg:h-[73vh]  md:h-[73vh]
                      transition duration-300 hover:shadow-lg hover:shadow-gray-600">
        <img
          src="https://sallysbakingaddiction.com/wp-content/uploads/2022/08/homemade-pumpkin-pie-spice-3-600x900.jpg"
          alt=""
          className="object-cover h-[300px] w-full"
        />
        <h5 className="p-3 text-xl font-semibold text-gray-900 group-hover:text-gray-800 transition duration-300 ">
    ...
    >
      <div className="group flex flex-col bg-[#F5F3F2] cursor-pointer lg:h-[73vh]  md:h-[73vh]
                      transition duration-300 hover:shadow-lg hover:shadow-gray-600">
        <img
          src="https://sallysbakingaddiction.com/wp-content/uploads/2015/09/apple-scones-with-caramel-600x900.jpg"
          alt=""
          className="object-cover h-[300px] w-full"
        />
        <h5 className="p-3 text-xl font-semibold text-gray-900 group-hover:text-gray-800 transition duration-300 ">
    ...
    >
      <div className="group flex flex-col bg-[#F5F3F2] cursor-pointer lg:h-[73vh]  md:h-[73vh]
                      transition duration-300 hover:shadow-lg hover:shadow-gray-600">
        <img
          src="https://sallysbakingaddiction.com/wp-content/uploads/2018/09/apple-cider-doughnuts-600x900.jpg"
          alt=""
          className="object-cover h-[300px] w-full"
        />
        <h5 className="p-3 text-xl font-semibold text-gray-900 group-hover:text-gray-800 transition duration-300 ">
    ...
    >
      <div className="group flex flex-col bg-[#F5F3F2] cursor-pointer lg:h-[73vh]  md:h-[73vh]
                      transition duration-300 hover:shadow-lg hover:shadow-gray-600">
        <img
          src="https://sallysbakingaddiction.com/wp-content/uploads/2013/09/pumpkin-crumb-cake-600x900.jpg"
          alt=""
          className="object-cover h-[300px] w-full"
        />
        <h5 className="p-3 text-xl font-semibold text-gray-900 group-hover:text-gray-800 transition duration-300 ">
