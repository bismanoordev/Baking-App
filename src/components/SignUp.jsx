      ...
      >
        ...
        <div className="flex flex-col justify-between w-full md:w-1/2 p-10 leading-relaxed">
          ...
          <p className="mb-6 text-lg font-normal text-gray-700 dark:text-gray-400">
            Something sweet for your inbox! Join 250K others and subscribe to my free email list. You’ll get every new recipe and baking post as they’re published, plus an email with my most popular baking tips and recipes.
          </p>
        ...
        {/* Right: Image */}
        <img
          className="object-cover w-full h-[25rem] md:h-[35rem] md:w-1/2"
          src="https://embed.filekitcdn.com/e/gjcUYKpfz85DEqCXjh6qUd/3MPAPQZDEV9W8aJmkKCESY"
          alt="Baking recipes"
        />
      </a>
    </div>
